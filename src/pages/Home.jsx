  ...
  return (
    <div className="container-fluid container-lg my-lg-5 my-3 pb-5">
      <div className="titulo-principal d-flex align-items-center mb-3">
        ...
        <div>
          <h4 className="font-weight-bold text-muted mb-0">SIRVes</h4>
          <h6 className="text-info mb-0"> Programa de Salud Mental</h6>
        </div>
      </div>
      ...
      <div className="card shadow-sm">
        <div className="card-body">
          <div className="card-text">
            <p>Bienvenida/o, Usuario de SIRVes </p>
            <p>
              Tu usuario está asociado a <strong> SIRVes</strong>. Ante
            ...
            <p></p>
            <p>
              El sistema permite cargar los datos de personas, sus diferentes
              licencias, bonificaciones y certificaciones a lo largo de su
              tiempo trabajado en la provincia.
            </p>
            {/* <p>
